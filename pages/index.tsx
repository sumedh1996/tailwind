...
export default function Home() {
  ...
  <div class="flex items-center space-x-3.5 sm:space-x-5 lg:space-x-3.5 xl:space-x-5">
    <img src="https://images.unsplash.com/photo-1609635919088-2d76ee51be08?ixid=MXwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw1fHx8ZW58MHx8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" width="160" height="160" class="flex-none w-20 h-20 rounded-lg bg-gray-100" />
